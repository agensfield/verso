...
var commandHelp = map[string]string{
	...
	"preview":  "verso preview <account> [--json]\n\nCheck a switch without network access, credential refresh, or account changes.\n",
